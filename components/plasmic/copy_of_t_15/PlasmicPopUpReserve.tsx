...
import sty from "./PlasmicPopUpReserve.module.css"; // plasmic-import: Xbak1OOCZd_u/css
...
function PlasmicPopUpReserve__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox___6NnSl, {
          [sty.freeBoxisVisible2___6NnSljQgpO]: hasVariant(
            $state,
            "isVisible2",
            "isVisible2"
          ),
          [sty.freeBoxis___6NnSlv1KOz]: hasVariant($state, "is", "is")
        })}
      >
        <h2
        ...
        <div className={classNames(projectcss.all, sty.freeBox__fJi4T)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__h7AJv)}>
          <div
            className={classNames(
              projectcss.all,
              projectcss.__wab_text,
        ...
        <div className={classNames(projectcss.all, sty.freeBox__ssoUz)}>
          <Button
