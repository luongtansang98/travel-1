...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: X89qbgTR7emC/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: UUsKfaTcrsge/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__r3Dl1)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__eJQc)}
              />
            </React.Fragment>
          ),
          value: args.children
